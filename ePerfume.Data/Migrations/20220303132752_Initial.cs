        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2022, 3, 3, 20, 27, 51, 436, DateTimeKind.Local).AddTicks(8971)),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "HomeTitle", "This is home page of ePerfume" },
                    { "HomeKeyword", "This is key word of ePerfume" },
                    { "HomeDescription", "This is desscription of ePerfume" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "en-US", false, "Enghlish" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DateCreated", "OriginalPrice", "Price", "SeoAlias" },
                values: new object[] { 1, new DateTime(2022, 3, 3, 20, 27, 51, 450, DateTimeKind.Local).AddTicks(5151), 100000m, 200000m, "" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "vi-VN", "Áo Nam", "Sản phẩm áo thời trang nam", "Sản phẩm áo thời trang nam", null },
                    { 3, 2, "vi-VN", "Áo Nữ", "Sản phẩm áo thời trang nữ", "Sản phẩm áo thời trang nữ", null },
                    { 2, 1, "en-US", "Men Shirt", "The Shirt products for men", "The Shirt products for men", null },
                    { 4, 2, "en-US", "Women Shirt", "The Shirt products for women", "The Shirt products for women", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "", "Áo sơ mi nam trắng Việt Tiến", "vi-VN", "Áo sơ mi nam trắng Việt Tiến", 1, "ao-so-mi-nam-trang-nam-viet-tien", "Áo sơ mi nam trắng Việt Tiến", "Áo sơ mi nam trắng Việt Tiến" },
